...
<div class="container-fluid">
    <a class="navbar-brand" href="#">
      <svg class="logo mb-3 mt-3" width="30" height="30" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="navbar-nav">
        ...
        <ul class="navbar-nav ml-auto">
            <?php if (!isset($_SESSION['auth_status'])) : ?>
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?php echo BASE_URL; ?>registration" tabindex="-1" aria-disabled="true">Register</a>
              </li>
